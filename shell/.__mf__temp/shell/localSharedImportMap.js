    ...
    const importMap = {
      ...
      ,
        "react-hot-toast": async () => {
          let pkg = await import("__mf__virtual/__mfe_internal__shell__prebuild__react_mf_2_hot_mf_2_toast__prebuild__.js");
            return pkg;
        }
      ,
