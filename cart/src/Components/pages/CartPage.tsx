...
const CartPage = () => {
  const { items, removeFromCart, increaseQty, decreaseQty, totalPrice, clearCart } = useCartStore();
            ...
            {items.map((item) => (
              <div key={item.id} style={{
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <p style={{ fontSize: 12, color: "#52525b", margin: "4px 0 10px",
                    overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap",
                  }}>
                    {item.description || "No description"}
                  </p>
                  <p style={{ fontSize: 17, fontWeight: 800, color: "#a855f7", margin: 0 }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: "rgba(239,68,68,0.08)",
                    border: "1px solid rgba(239,68,68,0.2)",
                    color: "#f87171", cursor: "pointer", fontSize: 15,
                    display: "flex", alignItems: "center", justifyContent: "center",
                  }}
                >✕</button>
              </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 16 }}>
              {items.map((item) => (
                <div key={item.id} style={{
                  ...
                  <span className="absolute top-2 right-2 text-gray-500 hover:text-red-500 text-xl" style={{ color: "#71717a" }}>
