...
const ReceiptPage = () => {
  ...
  useEffect(() => {
    ...
    const customerName: string = localStorage.getItem("customerName") || "Customer";
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: 14, color: "#52525b", margin: "0 0 32px" }}>
          Your order has been placed successfully. Your expected shipping date
          is {shippingDate}.
        </p>
        ...
        >
          ...
          {[
            ...
            {
              label: "Session",
              value: sessionId ? sessionId.slice(0, 20) + "..." : "N/A",
            },
            {
              label: "Date",
        ...
        >
          ...
          >
            <iframe
              ...
              src={
                shippingMap ||
                `https://maps.google.com/maps?q=${encodeURIComponent(shippingAddress)}&t=&z=13&ie=UTF8&iwloc=&output=embed`
              }
            />
          </div>
        </div>
